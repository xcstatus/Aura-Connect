pub fn tr(key: &'static str) -> &'static str {
    match key {
        ...
        "iced.settings.cat.color_scheme" => "Color Scheme",
        ...
        "iced.settings.sub.color_scheme.presets" => "Presets",
        ...
        "iced.settings.section.color_scheme" => "Color Scheme",
        ...
        "iced.welcome.quick_connect" => "Quick Connect",
        "iced.welcome.recent" => "Recent Connections",
        "iced.welcome.settings" => "Settings",
        "iced.welcome.or" => "or",
        ...
        "settings.security.hosts.table.col.added_at" => "Added at",
        "settings.security.hosts.delete" => "Delete",
        "settings.security.hosts.detail.title" => "Details",
        "settings.security.hosts.detail.algorithm" => "Algorithm",
        "settings.security.hosts.detail.fingerprint" => "SHA256 Fingerprint",
        "settings.security.hosts.empty" => "No trusted hosts",
        ...
        "iced.sftp.error.permission" => "Permission denied",
        "iced.sftp.error.not_found" => "Path not found",
        "iced.sftp.error.network" => "Network interrupted",
        "iced.sftp.menu.download" => "Download",
        "iced.sftp.menu.download_folder" => "Download Folder",
        "iced.sftp.menu.copy_path" => "Copy Path",
        "iced.sftp.menu.delete" => "Delete",
        "iced.sftp.menu.create_folder" => "New Folder",
        "iced.sftp.menu.refresh" => "Refresh",
        ...
        "iced.sftp.transfer.failed" => "Failed",
        "iced.sftp.transfer.cancelled" => "Cancelled",
        "iced.sftp.transfer.cancel" => "Cancel",
        "iced.sftp.transfer.clear" => "Clear Completed",
        "iced.sftp.header.name" => "Name",
