...
pub fn inline_connecting_overlay(state: &IcedState) -> Element<'_, Message> {
    let is_connecting = !state.quick_connect_open
        && matches!(state.quick_connect_flow, crate::iced_app::state::QuickConnectFlow::Connecting);
    ...
    let stage_label = match stage {
        crate::iced_app::state::ConnectionStage::VaultLoading => state.model.i18n.tr("iced.stage.vault_loading"),
        crate::iced_app::state::ConnectionStage::SshConnecting => state.model.i18n.tr("iced.stage.ssh_connecting"),
        crate::iced_app::state::ConnectionStage::Authenticating => state.model.i18n.tr("iced.stage.authenticating"),
        crate::iced_app::state::ConnectionStage::SessionSetup => state.model.i18n.tr("iced.stage.session_setup"),
